...
struct Bill: Equatable {
    ...
    internal init(value: Double, currency: Currency, billName: String, billDescription: String, category: Category, modifiedDate: Date = Date(), creationDate: Date = Date(), uuid: String = UUID().uuidString) {
